  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-white border-2 border-gray-800 border-t-gray-900 border-l-gray-900 p-4 sm:p-6 shadow-inner space-y-6">
          ...
          <section className="space-y-3">
            <div className="flex items-center gap-3 border-b-2 border-gray-200 pb-2">
              ...
              <div>
                <h1 className="text-3xl font-bold font-crt text-[#000080]">
            ...
            <p className="font-body text-[1.05rem] text-[#111111] leading-[1.7]">
          ...
          <fieldset className="border-2 border-gray-400 p-4 bg-[#f8f8f8] shadow-sm">
            <legend className="font-win98 font-bold text-xs text-[#000080] px-2 bg-[#c0c0c0] border border-gray-600">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2 font-body text-sm">
              <div className="bg-white p-3 border border-gray-300 shadow-inner">
                <h3 className="font-crt font-bold text-lg text-[#000080] border-b border-gray-300 pb-1 mb-2">
          ...
          <section className="space-y-3 pt-2">
            <h2 className="text-2xl font-bold font-crt text-[#000080] border-b border-gray-300 pb-1">
            ...
            <div className="flex flex-wrap gap-3 font-win98 text-xs">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 px-3 py-1.5 border-2 border-t-white border-l-white border-b-black border-r-black bg-[#c0c0c0] hover:bg-[#d4d4d4] text-black font-bold no-underline"
              >
                <span>🐙</span>
